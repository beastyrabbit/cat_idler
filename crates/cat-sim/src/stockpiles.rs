...
pub fn set_resource(resources: &mut Resources, kind: ResourceKind, value: f64) {
    match kind {
        ...
        ResourceKind::Preserves => resources.preserves = value,
        ResourceKind::Medicine => resources.medicine = value,
        ResourceKind::Brew => resources.brew = value,
        ...
        ResourceKind::Thread => resources.thread = value,
...
pub const fn storage_capacity_for(caps: StorageCapacities, kind: ResourceKind) -> f64 {
    match kind {
        ...
        ResourceKind::Preserves => caps.preserves,
        ResourceKind::Medicine => caps.medicine,
        ResourceKind::Brew => caps.brew,
        ...
        ResourceKind::Thread => caps.thread,
