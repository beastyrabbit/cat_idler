...
fn action_name(action: &proto::ClientAction) -> &'static str {
    match action {
        ...
        proto::ClientAction::QueueResearchPath { .. } => "queue_research_path",
        proto::ClientAction::QueueRepeatableResearch { .. } => "queue_repeatable_research",
        proto::ClientAction::MoveQueuedResearch { .. } => "move_queued_research",
        proto::ClientAction::RemoveQueuedResearch { .. } => "remove_queued_research",
        proto::ClientAction::UpgradeBuilding { .. } => "upgrade_building",
        ...
        proto::ClientAction::CreateTransportRoute { .. } => "create_transport_route",
        proto::ClientAction::CancelTransportRoute { .. } => "cancel_transport_route",
