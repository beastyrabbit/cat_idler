...
A complete final noncampaign run passed all 548 cases in 8.3783 seconds. The 46 regression cases also passed separately in 1.7105 seconds. All nine campaign twins passed in 173.5356 seconds after the final cargo-handoff, infrastructure-resume, perimeter and trade-cancellation corrections. Every original founding cat survived, and no colony reset. These results supersede the earlier candidate runs.
