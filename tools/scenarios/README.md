...
The current inventory is 645 noncampaign cases and nine campaign twins. See `VALIDATION.md` and the result files for the verified source and remaining limits.
