...
| P12 | Sim expansion: skills, officers, spatial stockpiles, workshop chains | in progress — seven specialist manual/officer domains, a narrow founding Leader Hunt/FetchWater/Scout safety floor, all 19 maintained skill gain/effect/UI paths, role gates, active shrine faucets, useful tools/costs, finite storage, and physical Sawmill/fishing routes are verified through exact 48-hour personal/communal campaigns; finish other physical chains/recipes |
...
| P19 | Item/material economy: crafting chains, traders, coin | in progress — planks/blocks/tools, grain/flour/food, logs/lumber, fibre/cloth, hide/leather, ore/metal, protected useful tools, material trade goods, visiting traders, coin, and conserved fishing cargo are live; recipe/material breadth, broader physical local inventories, and complete controls remain |
...
- Physical fishing now uses persisted player-designated revealed shore tiles, real worker
  travel/work/return, finite food cargo and storage, truthful Fishing/Haul skills, Farmer
  automation, signed exact controls, restart/death conservation, and multi-seed live-cadence
  guided/unattended campaigns. Transport upgrade flags still need real routes and vehicles:
