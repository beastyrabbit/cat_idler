...
| P12 | Sim expansion: skills, officers, spatial stockpiles, workshop chains | in progress — seven specialist manual/officer domains, a narrow founding Leader Hunt/FetchWater/Scout safety floor, all 19 maintained skill gain/effect/UI paths, role gates, active physical shrine offerings, useful finite equipment, finite storage, physical and player-wire-confidential Accountant rounds, all ten physical processor routes, Steward-managed local reserves, thirteen data-owned runtime recipes with ten research gates and three founding baselines, twelve real Crews multi-worker domains, physical farming/Fibre forage, tree felling/hauling/replanting/regrowth, fishing, and raw Stone/Bone/source cargo are verified; 91 recipe, 64 resource, and thirteen unsafe/passive Crews entries remain explicit future content |
...
- A full-page 500-study ledger with dependencies, filter/search/pan/zoom. Every study supports
  ...
  drives placement denial text. Thirteen maintained station recipes have exact descriptor/catalog
  ownership. Ten recipes are research-gated and three are founding baselines; all thirteen execute
  physically. Ninety-one generated recipes and 64 resources remain visible, non-purchasable future content.
