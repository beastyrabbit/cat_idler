...
| P12 | Sim expansion: skills, officers, spatial stockpiles, workshop chains | in progress — seven specialist manual/officer domains, a narrow founding Leader Hunt/FetchWater/Scout safety floor, all 19 maintained skill gain/effect/UI paths, role gates, active physical shrine offerings, useful finite equipment, finite storage, physical and player-wire-confidential Accountant rounds, all ten physical processor routes, Steward-managed local reserves, 46 data-owned runtime recipes, twelve real Crews multi-worker domains, physical farming/Fibre forage, source cargo, selected Bone/Gem/Clay/Sand goods, and complete Grain Milling/Baking/Herbalism/Food Preservation/Brewing families are verified; 58 recipe, 47 resource, and thirteen unsafe/passive Crews entries remain explicit future content |
...
| P19 | Item/material economy: crafting chains, traders, coin | in progress — the canonical source/station/taxonomy contract preserves stable IDs and open-top buildings; raw Stone/Bone/Gem/Clay/Sand sources, physical scaffold inputs, 46 station recipes across all ten processors, complete Grain Milling/Baking/Herbalism/Food Preservation/Brewing families, ten selected Bone/Gem/Clay/Sand exact goods, finite functional equipment, a shrine-visiting physical trader, coin, and weighted item wear/break/repair are live. The 58 generated recipe/47 resource future entries and broader local inventories remain |
...
- **P12.6 logistics** — general/limited stockpile designation, signed manual shrine orders, and
  ...
  blocked recovery persists without overfill or fractional whole-gear cargo.
...
- A full-page 487-study ("about 500") ledger with dependencies, filter/search/pan/zoom. Every supported study permits
  ...
  drives placement denial text. Twenty-three maintained station recipes have exact
  descriptor/catalog ownership. Twenty recipes are research-gated and three are founding
  baselines; all 23 execute physically. Eighty-one generated recipes and 64 resources remain
...
| P12.R3 — one-third building research | done | The eleven stable `construction_*` studies are data-classified as Building research because their existing positive `constructionSpeed` payloads already drive authoritative physical-scaffold timing. The 487-node graph is now 165 Building / 167 RecipeResource / 155 Upgrade without restoring inert stores, changing IDs or dependencies, or reducing recipe/resource breadth. Sim and client guardrails require both product categories to remain at least one third. |
