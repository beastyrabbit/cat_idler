...
- **P12.4a/b workshop chains + Accountant direction** — workshop crafting covers
  ...
  Clothier, Tannery, and Smithy to one-worker physical queues; then
...
- Remaining breadth includes physical Clothier, Tannery, and Smithy queues; Bone item variants plus
