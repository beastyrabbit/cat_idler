...
| P12 | Sim expansion: skills, officers, spatial stockpiles, workshop chains | in progress — seven specialist manual/officer domains, a narrow founding Leader Hunt/FetchWater/Scout safety floor, all 19 maintained skill gain/effect/UI paths, role gates, active physical shrine offerings, useful tools/costs, finite storage, physical and player-wire-confidential Accountant rounds, physical Mill/Sawmill/Wood Cutter/Stone Prep/Workshop/Smelter routes, Steward-managed local reserves, eleven data-owned station recipe descriptors with eight enforced production gates and three founding-available baselines, physical farming, tree felling/hauling/replanting/regrowth, fishing, and the P19 raw Stone/Bone/source-cargo migration are verified; four aggregate benches, finite equipment authority, and 93 generated recipe IDs remain in progress |
| P13 | Client UI for P12: stockpile designation, officer assignment | in progress — designation/assignment, signed manual orders, exact building/farm/gather/road/governance controls, authoritative election timing, durable per-cat typed labor preferences, all six physical processors' editable add/remove/reorder/repeat/pause queues and truthful inspectors (including the exact missing study for a locked recipe), Steward pile provenance/route visibility, the purchasable 500-study ledger, crop/timber HUD state, visible farm stages, and distinct open station compositions shipped; extend the generic queue UI as broader physical recipes land |
...
| P19 | Item/material economy: crafting chains, traders, coin | in progress — the canonical source/station/taxonomy contract now reconciles P12 and P16 while preserving stable IDs and open-top buildings; raw Stone and Bone, physical quarry Stone/rubble/Ore and hunt Hide/Bone cargo, finite fresh Fish, physical scaffold inputs, eleven station recipe descriptors/default queues, useful tools, trade goods, a shrine-visiting physical trader with finite persisted stock/purse/wagon, coin, and stable weighted item units with wear/break/repair are live. Six remaining physical station conversions, finite functional-equipment authority, recipe/material breadth, and broader local inventories remain |
...
- **P12.4a/b workshop chains + Accountant direction** — workshop crafting covers
  ...
  Ore, and hunt Hide are carried cargo. Stone Prep is physical; next convert Woodworking, Clothier, Tannery,
  and Smithy to one-worker physical queues; then
...
- **P12.6 logistics** — general/limited stockpile designation, signed manual shrine orders, and
  ...
  seeded finite general storehouse and complete physical Mill/Sawmill/Wood Cutter/Stone Prep/Workshop/Smelter routes are
...
- A full-page 500-study ledger with dependencies, filter/search/pan/zoom. Every study supports
  ...
  ownership; eight enforce production while three behavior-neutral compatibility entries await
  physical conversion. Ninety-three generated recipes and 64 resources remain open.
...
- Remaining breadth includes physical Woodworking, Clothier, Tannery, and Smithy
  queues; Bone item variants plus finite gem/clay/metal raw stacks and variants; finished functional
  tool/weapon/armor chains, broader physical local inventories, and reachable exact client
  controls for every chain.
- Physical-economy follow-ups remain explicit: stations other than Mill/Sawmill/Wood Cutter/Stone Prep/Workshop/Smelter
