...
| P21-24 | qa | Map is a full-screen rectangular world map with coherent bounds/markers; the circular minimap is removed. |
...
| P21-27 | qa | Dispatches is removed; a compact top-middle event ticker shows current activity. |
