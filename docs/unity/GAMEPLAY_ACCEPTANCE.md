...
| Construction | The exact bill is reserved before work. A builder carries inputs, and construction advances only after the inputs arrive. Builder death or reassignment preserves delivered inputs and paid progress. Food and surplus Planks carried before a new assignment remain recoverable; construction consumes only its bill. |
| Roads and walls | Roads consume delivered material per completed tile. Interrupted roads, rails and expansion retain their job identity and suspended material claims when a replacement worker takes over. Expansion preserves every paid outer segment, opens the new gate and clears obsolete interior walls. Farms must remain exterior. |
...
The final September 6 simulation run passed 548 focused acceptance scenarios in 8.3783 seconds, including all 108 recipes, 487 research purchases, runtime effects, 46 regressions and the three shipping recovery scenarios. The regression group also passed separately in 1.7105 seconds. Four review regressions first failed, then passed after corrections to construction's handling of carried Food and surplus Planks, Armor production delivery and Armor unequipping. Eight further cases cover new-building cargo, offerings, scouting, hauling and resumed roads, rails and expansion. Their failures led to preserving unrelated cargo before new or adopted work. The expansion case also exposed and now checks preservation of every paid perimeter segment. Existing assertions were preserved. These cases check public action chains, finite material bills, recoverable cargo, accepting storage and exact item identity and condition.

After all final corrections, the delivery run also passed nine extended scenarios: fresh communal colonies for 48 hours, established communal colonies for 72 hours, and shared communal plus personal villages for 48 hours, each at seeds 7, 41 and 127. Each scenario compares a twin advanced in smaller partitions, checks invariants and tracks original founding identities so migrants cannot hide deaths. The complete matrix took 173.5356 seconds on this Mac. This rerun includes the shipping and imported-trade cancellation corrections; the campaign workloads themselves contain no transport routes, so focused shipping and authority/import scenarios provide that coverage. The established fixture has one staffed repeating Wood Cutter and finite initial supplies. It does not establish indefinite operation of a mature economy. The maintained import and Unity UI results are recorded by their respective test runners.
