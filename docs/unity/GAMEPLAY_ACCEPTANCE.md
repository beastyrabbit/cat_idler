...
The final September 6 simulation run passed 540 focused acceptance scenarios in 8.1122 seconds, including all 108 recipes, 487 research purchases, runtime effects, 38 regressions and the three shipping recovery scenarios. The regression group also passed separately in 1.4725 seconds. Four new review regressions first failed, then passed after corrections to construction's handling of carried Food and surplus Planks, Armor production delivery and Armor unequipping. Existing assertions were preserved. These cases check public action chains, finite material bills, recoverable cargo, accepting storage and exact item identity and condition.

After the conservation, authority and terrain fixes, the final run also passed nine extended scenarios: fresh communal colonies for 48 hours, established communal colonies for 72 hours, and shared communal plus personal villages for 48 hours, each at seeds 7, 41 and 127. Each scenario compares a twin advanced in smaller partitions, checks invariants and tracks original founding identities so migrants cannot hide deaths. The complete matrix took 161.2604 seconds on this Mac. This rerun includes the shipping corrections; the campaign workloads themselves contain no transport routes, so the focused shipping scenarios provide that coverage. The established fixture has one staffed repeating Wood Cutter and finite initial supplies. It does not establish indefinite operation of a mature economy. The maintained import and Unity UI results are recorded by their respective test runners.
