...
The final simulation run passed 617 noncampaign scenarios in 16.7938 seconds, including all 108 recipes, 487 research purchases, runtime effects, 115 regressions and the three shipping recovery scenarios. The regressions also passed separately in 3.8146 seconds. Earlier failures led to corrections for carried Food and surplus Planks, Armor storage, new-work cargo, and resumed infrastructure. Thirty territory cases cover foreign claims and physical footprints during planning, work, founding and recovery.
...
Nine extended scenarios passed in 208.8116 seconds after the housing and expansion corrections: fresh communal colonies for 48 hours, established communal colonies for 72 hours, and shared communal plus personal villages for 48 hours, each at seeds 7, 41 and 127. Each compares a twin advanced in smaller partitions, checks invariants and tracks original founding identities so migrants cannot hide deaths. All founding cats survived without a reset. These workloads create no road, rail or expansion jobs, transport routes or imported batch outputs. The final 617-case run directly covers infrastructure guards, physical construction and interrupted resumption. Authority/import tests cover imported output delivery and restart separately. The established campaign has one staffed repeating Wood Cutter and finite initial supplies; it does not establish indefinite operation of a mature economy.
