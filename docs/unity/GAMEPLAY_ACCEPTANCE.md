...
The final simulation run passed 632 noncampaign scenarios in 21.4884 seconds, including all 108 recipes, 487 research purchases, runtime effects, 130 regressions and the three shipping recovery scenarios. The regressions also passed separately in 10.8147 seconds. Earlier failures led to corrections for carried Food and surplus Planks, Armor storage, new-work cargo, and resumed infrastructure. Thirty territory cases cover foreign claims and physical footprints during planning, work, founding and recovery.
