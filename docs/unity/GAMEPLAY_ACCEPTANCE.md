...
The final September 6 simulation run passed 558 focused acceptance scenarios in 8.2346 seconds, including all 108 recipes, 487 research purchases, runtime effects, 56 regressions and the three shipping recovery scenarios. Earlier failing cases led to corrections for construction's handling of carried Food and surplus Planks, Armor storage, new-work cargo, and resumed roads, rails and expansion. The expansion case also checks every paid perimeter segment. Existing assertions were preserved.
...
Nine extended scenarios passed in 163.8627 seconds before the final imported-batch delivery fix: fresh communal colonies for 48 hours, established communal colonies for 72 hours, and shared communal plus personal villages for 48 hours, each at seeds 7, 41 and 127. Each scenario compares a twin advanced in smaller partitions, checks invariants and tracks original founding identities so migrants cannot hide deaths. These workloads contain no transport routes or imported batch outputs. The final focused, authority and Unity suites include the batch fix and provide its direct evidence. The established campaign has one staffed repeating Wood Cutter and finite initial supplies; it does not establish indefinite operation of a mature economy.
