...
The final simulation run passed 636 noncampaign scenarios in 23.2803 seconds, including all 108 recipes, 487 research purchases, runtime effects, 134 regressions and the three shipping recovery scenarios. The regressions also passed separately in 11.1153 seconds. Earlier failures led to corrections for carried Food and surplus Planks, Armor storage, new-work cargo, and resumed infrastructure. Thirty territory cases cover foreign claims and physical footprints during planning, work, founding and recovery.
