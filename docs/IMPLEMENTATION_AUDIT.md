...
| Production breadth | The maintained production chains include physical Fibre→Cloth, Hide→Leather, selected Metal→Tool/Weapon/Armor, ten exact Bone/Gem/Clay/Sand goods, and complete Grain Milling/Baking/Herbalism/Food Preservation/Brewing families. Preserves, Medicine, and Brew have finite storage, cargo, trade, and survival consumers. Broader sourced recipes and variants remain. | in progress | Extend the same finite source/station/item contract to remaining selected breadth |
...
| Item and recipe breadth | Live crafting now includes selected Bone tools/decor/toys, Gem jewelry, Clay pottery/bricks, Sand glassy goods, and 23 additional food/plant recipes. The new scalar goods remain finite pile/cargo identities with physical consumers. The remaining 58 generated recipes and 47 generated resources remain future breadth. Functional Tool/Weapon/Armor chains retain one finite-object authority; stable scalar fields are derived compatibility projections. | in progress | Add only design-selected combinations with the same complete physical contract |
...
| `p19-items-materials-trade.md` | canonical taxonomy, implementation partial | Stable source/station names, open-top stations, all ten processors, 46 selected physical recipes, complete food/plant families, ten exact Bone/Gem/Clay/Sand goods, finite functional equipment, scaffold delivery, wear/repair, and physical trade are live. Remaining work is the 58 recipe/47 resource future breadth in `RECIPE_RESOURCE_MATRIX.md` and deeper inventories. |
