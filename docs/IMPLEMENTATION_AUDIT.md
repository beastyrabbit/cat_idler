...
| --- | --- | --- | --- |
| Integrated correction gate | The physical Fibre→Thread→Cloth and canonical Mug routes, selectable Food/Herbs/Materials offerings, connected 16-mask roads, single-body cat reconciliation, resolved 2×3 tree footprints, and compact HUD/Stores/category dock are implemented with focused coverage. | verified | Exact one-second 48h passive campaigns on three seeds retain all 15 cats with zero deaths/resets and exercise survival, elections, hunting, water, shrine-return fog, and scouting. One observed-state signed campaign covers all 52 public actions, production, research, offerings, trade, expansion, persistence, Rail/Shipping, and conservation. Inspected complete client-owned default/Gather/Stores frames at 1024×768 and 1920×1080 show connected junctions, one body per cat, collision-free canopies, the compact dock, full Stores view, and an unclipped world. |
| Shrine economy | Population-relative surplus gates make food/refined tithes and physically carried player-selected Food, Herbs, or Materials offerings reachable without draining survival or construction reserves. Both faucets credit one canonical spendable blessing bank: its current balance drives fertility, god-purchases debit it immediately, cat research points remain separate, extinction preserves the remainder, and both the resource HUD and research ledger project the same value without inventing stockpiled blessings. | verified | Focused signed tests cover all three selected resources, legacy `OfferMaterials` compatibility, tithe separation, physical delivery, exact conception chance before/after credit and spending, no-double-credit, cat-research separation, snapshot, deterministic extinction-reset, reserve, cooldown, and recovery; the generalized signed campaign exercises each offering path. |
...
| Research runtime | A player may spend research points on any affordable study in the truthful 487-node (“about 500”) catalog, while blessings remain a distinct original-node path. The living Leader may complete at most one affordable full-catalog study per rolling real-life day; research labor/building automation and rituals remain Loremaster-owned. Ownership, the colony-wide last-choice clock, and typed modeled effects persist. All 165 Building studies are purchasable and consumed; thirteen generated capacity studies with no physical container remain retired, with old ownership removed by an exact one-time point refund. | verified | Exhaustive 487/487 dependency-order purchase and payload resolution, zero-`FUTURE` guard, all-Building live guard, exact service mapping/behavior, signed unlimited manual purchases, retired-node migration, living/dead/replacement authority, exact 24-hour boundary/reset/no-backlog behavior, legacy-column SQLite restart, crisis non-staffing, deterministic pacing, and truthful research-ledger copy |
...
| Physical personal needs | Eat, Drink, and Sleep are spatial tasks rather than scalar regeneration. Living cats take finite visible Food/Fish/Water servings at a reachable pile, consume only at a dining/drinking destination, reserve one of five real Den beds, and resume persisted interrupted work only after returning to its work point. | verified | Debit/arrival, blocked/death conservation, bed capacity, serialized resume, passive twins, live-second player-guided water, probationer, dehydration, population, farming/processing, communal, and 300h seed campaigns |
...
| Useful labor pressure | Read-only telemetry separates assigned and visibly active cats, true idle cats, intentional manual-only offices, sourced processor vacancies, workable farms, and staffed jobs/transports. Paused, locked, missing-input, and full-output stations do not count. A player can fill all 15 founding paws with meaningful physical work and still have one sourced processor vacancy; one additional signed hunt then fails only for lack of a worker. | verified | Seeds 7/555/2024 founding saturation (16 useful slots/15 cats); three-seed 200h guided five-minute twins with positive stores/no resets/workforce-only denials; personal+communal 48h passive proxy twins; existing exact one-second 48h controls; observed 7→0 officer states; full 52-action production/research/road/farm/scout/Rail/Shipping campaign |
| Manual controls | Every currently modeled management path has a signed client control: farm/gather/road painting, exact construction, staffing, clear/remove, governance, raw resources, expansion, defense/training, selectable ritual/shrine offerings, hauling, research, durable per-cat typed labor preferences, and all ten physical processors' add/remove/reorder/repeat/pause queues. Preferences bias eligible matching without bypassing survival, liveness, busy, station, unlock, or officer gates. | verified | The deterministic longitudinal and observed-state gates cover all 52 public action variants, including selectable Food/Herbs/Materials offerings, exact equip/unequip, village caravan offer/accept/cancel, constructed Rail/Shipping controls, foreign-village denial, HMAC/SQLite restart, death durability, queue conservation/no-early-credit, and exact placement/governance. |
...
| Spatial placement | Player and leader placement validates and commits atomically across terrain, claims, buildings, roads, stockpiles, gather spots, queued footprints, rendered 2×3 tree canopies, and 1×1 rocks. One deterministic decoration authority rejects tree/tree, tree/rock, tree/water, wall, and structure overlap across chunk boundaries. Buildings and trees are exact soft obstacles; water, mountains, and walls remain hard obstacles. | verified | Atomic placement/reservation campaigns, climate-decoration source parity, multi-cell and cross-chunk footprint collision tests, soft-obstacle path tests, clear-interior evidence, and inspected generalized collision-free canopy frames pass. |
| Staged wall growth | Expansion constructs a durable outer perimeter while the complete old enclosure and exact south gate remain authoritative. Finished prospective segments block travel; death, officer interruption, and restart preserve progress; completing every segment atomically cuts over to one new south gate and retires the old shared edge. Wall cells use a square top-down sharpened-timber sprite rather than a stretched side-view rail. | verified | Interrupted/resumed construction, closure, pathfinding, one-gate cutover, persistence, Sawmill compatibility, accepted before/during/after framebuffers, and the inspected 1090×2105 top-down palisade frame |
...
| Multi-village model | One canonical global village remains viewable by anonymous sockets and controllable by every authenticated player. Each stable signed identity can found exactly one deterministic distant personal village; ownership, selected routing, and foreign denial survive reconnect/restart. Explicit scout-delivery provenance creates mutual summary-only contact. Accepted offers debit exact source piles or finite equipment identities into durable escrow and create a visible caravan that follows one persisted obstacle-aware land route through both real gates, returns before credit, and can be cancelled without loss by either controller. | verified | Deterministic site/collision, signed two-player founding/discovery/trade, scalar and collision-qualified exact-item manifests, shared water/mountain/wall detours and no-route rejection, long-distance bounds, exact route restart, condition preservation, cancellation/full-storage/cadence/no-fog-leak, transactional SQLite restart, projection, controls, and framebuffer |
| Shared-world depth | A durable `Communal` hub and exact personal villages share one canonical mutable tile/Fish authority while fog/contact remain private. Barter follows a bounded deterministic shared-terrain route, and exact Tool/Weapon/Armor ownership transfers without identity collision. | verified | Shared overlap, legacy migration, obstacle-aware gate-to-gate caravans, persisted exact/reverse waypoints, long-distance bounds, no-route atomicity, restart, and private fog are verified. Deeper encounters remain optional future breadth. |
...
| Canonical production contract | P19 owns the stable taxonomy and physical source/station boundary. All ten maintained processors and all 108 recipes are physical. Fibre→Thread→Cloth and the four canonical Mug materials use selected queues and ordinary hauling. Every generated recipe/resource payload has an authoritative consumer. Tool/Weapon/Armor identity, location, condition, equipment, work/combat wear, repair, escrow, and exact sale have one finite authority. | verified | Rules-v0–v7 plus finite-equipment rules-v1, all 108 descriptors, zero unsupported recipe/resource payloads, focused capacity/conservation/persistence/signed/passive routes, exact-ID lifecycle, prior processor/equipment frames, and the combined production campaign pass. |
| Physical workshop logistics | All ten processors are physical, including Fibre→Thread→Cloth, Hide→Leather, and selected Metal→Weapon/Armor routes. Aggregate credit waits for final delivery; queue/transit/local state persists; capacity, death, removal, and replacement workers conserve cargo. | verified | Ten-station provenance, capacity, recovery, restart, live-cadence, focused signed controls, determinism, and the generalized whole-game route pass. |
...
| Workshop inspector | All ten maintained physical processor snapshots and the Bevy inspector expose the real worker, travel direction, editable queue, local input/output, inbound/outbound cargo, progress, and blocked reason. Steward-managed pile inspectors expose active/dormant ownership, resolved station type, route phase, worker, and blocked recovery; unselected managed zones keep their typed overlays/props without persistent text plaques. | verified | All ten station persistence/queue paths and Steward protocol/client coverage pass; sampled accepted own-framebuffers show Mill local/outbound Flour, Workshop Refined in route, Smelter Metal in route, Tannery Hide/Leather in route, Clothier Fibre/Cloth in route, and a selected Steward-managed Sawmill Logs pile with readable provenance and no overlap |
...
| Production breadth | All 108 maintained runtime recipes are physical. Complete food/plant, subsistence/frontier, and industrial material families cover Grain Milling, Baking, Herbalism, Food Preservation, Brewing, Hunting, Foraging, Waterworks, Animal Husbandry, Field Craft, Expedition Supplies, Textile Work, Leatherworking, Carpentry, Stonecraft, Metallurgy, Toolmaking, Weaponcraft, Armorcraft, and Trade Goods. Scalar batches remain finite and exact goods keep one identity through production, storage, equipment where functional, and trade. | verified | Exhaustive catalog, descriptor, finite-input/output, signed queue, persistence, default-automation compatibility, and generalized campaigns cover every generated recipe/resource payload. |
| Fine-biome resource ecology | All 26 fine biomes affect travel. Mountains own finite Gem deposits, marsh/swamp/badlands own finite Clay, and beach/desert own finite Sand; physical quarry pickup drains the exact persisted tile and distinct cargo must reach storage before aggregate credit. Village interiors remain resource-free. Selected Gem jewelry, Clay pottery/brick, Sand glassy goods, and Bone tools/decor/toys now complete the first downstream variant slice. | verified | Exhaustive source presence/absence plus ten exact raw→station→item routes, persistence, trade, signed/passive campaigns, protocol, and client controls verify the complete selected slice |
| Research effect truth | All 487 nodes in the dependency graph are purchasable, persistent, and consumed. All 108 runtime recipes are physical, and every generated recipe/resource payload has an exact descriptor or yield/input, durability/spoilage, cycle, or finite-capacity consumer. All 165 Building studies are live: physical yield/durability/capacity/cycle modifiers drive their exact station, twelve Crews studies add independent worker state, and thirteen stable Crews IDs provide completed-building-gated housing, preservation, water, rest, medicine, kitten/elder care, defense, physical Mouse Farm Food, blessing, harvest, combat, or accounting service rather than fake slots. Thirteen containerless capacity studies remain intentionally absent with one-time refunds. | verified | Exhaustive 487/487 dependency-order purchase and zero-FUTURE guards, all 108 descriptors, signed/passive routes, exact identity, building behavior, death/reassignment/restart/full-storage conservation, the recipe/resource matrix, and the integrated whole-game campaign pass. |
| Founding stockpile contract | P16's live finite personal-village mix is canonical at founding and extinction recovery: 50 food, 100 water, 16 herbs, 60 general materials, 10 planks, and 10 blocks, doubled for the communal blueprint; every other maintained scalar resource, including Thread, starts at zero. | verified | Exact 32-field aggregate and finite general-storehouse content assertions, exact communal 2× scaling, single-store/no-legacy-shrine and repeated-reconciliation checks, bit-exact physical-pile conservation, and deterministic personal/communal extinction recovery |
| Client visibility | Every maintained scalar resource has unique semantic art, labels, paths, tints, and a live value without aliases. Every physical `CarryingKind` reuses its exact tracked identity above the moving cat; there is no colored-square fallback. The world card pins only survival-critical stores, while Stores [G] derives the complete inventory from the protocol. Stockpile totals, inspectors, farm stages, Fish habitat state, stations, and skills remain visible. | verified | The exhaustive 32-kind protocol/icon bijection and cargo map resolve tracked semantic PNGs, reject byte aliases and missing/non-PNG files, and keep all raw and processed identities distinct. Compact-HUD/Stores regressions and inspected 1024×768/1920×1080 generalized frames pass. |
| Transport and fishing | Physical shoreline fishing remains verified. Rail/Shipping ownership alone is still neutral for ordinary walkers, while signed construction now creates exact-reservation track, docks, rolling stock, and vessels. Staffed stockpile-to-stockpile routes own explicit adjacent track or dock-to-dock water paths plus Boarding/Loading/Outbound/Unloading/Returning phases, finite off-ledger transit cargo, destination-storage waits, cancellation/death recovery, vehicle release, snapshot visibility, and SQLite restart. The client renders track, docks, wagons, and vessels without labels. | verified | Neutral-blueprint A*/walking twins; signed guided route authorship; passive deterministic rail twins; staffed rail/vessel and paid-track campaigns; reservation, cancellation, death, full-storage, conservation, typed protocol, exact SQLite in-flight restart, and inspected client-owned transport framebuffer |
| Item and recipe breadth | Live crafting includes selected Bone/Gem/Clay/Sand goods, 23 additional food/plant recipes, 28 additional exact subsistence/frontier kits and wares, 18 scalar industrial batches, and twelve quality-mapped exact metal equipment recipes. All generated recipe/resource studies are live. Functional Tool/Weapon/Armor chains retain one finite-object authority; stable scalar fields are derived compatibility projections. | verified | Maintain the complete physical contract when adding future design-selected combinations |
| Finite item condition | Every item unit has a stable ID, weight, maximum/current durability, work-driven wear, and a persistent broken state at zero condition. Signed repair requires the appropriate completed staffed workshop, a living worker, and one visible matching material; durability research scales the restored condition. Each signed caravan sale accepts at most 20 kg of item weight. The Goods panel shows per-unit weight, condition range, damaged/broken counts, and a repair affordance across the complete maintained recipe/material graph. | verified | Unit identity/migration, wear/breakage, staffed material-backed repair and denial cases, research effect, trader capacity, deterministic twins, signed guided campaign, SQLite restart, protocol compatibility, and accepted Goods own-framebuffer |
...
| Physical road construction | Authored stone-road placement, shrine-network attachment, mapped-terrain validation, disjoint road surfaces, and movement effects are verified. Signed and Steward-authored routes now reserve one exact visible Material stack per tile; one living builder physically collects, carries, and works each ordered tile before paving and aggregate debit. Partial work, death/reassignment, exact-source/spill recovery, tile reservation, tool wear, cadence, and restart are durable. | verified | Signed action and passive Steward campaigns; exact pickup/arrival/work/debit, death, reservation-race, 1s/60s cadence, SQLite round trip, and full placement/movement regressions |
| Adventure UI skin | Tracked Adventure art drives sliced parchment, dark, and ornate panels; default, hovered, pressed, active, and disabled buttons; framed resource pills; need bars; the minimap ring; and pointer, interact, pressed, target, and disabled custom cursors across the HUD and research ledger. Prior native and optimized-WASM framebuffers verify the skin foundation at 1024×768, 1280×800, and 1920×1080. The maintained compact HUD, Stores menu, and category dock reuse that skin. | verified | Client/web tests, native and wasm32 strict checks, prior browser captures, a signed personal-village Explore/shrine-return campaign, and inspected current native default/Gather/Stores frames at 1024×768 and 1920×1080 verify the maintained compact presentation. |
| Visual truth | Persistent map plaques are removed. Residential rooms retain roof silhouettes; every maintained building, including the Accounting Tent, has a tested typed open/roofed composition, and the fixed core hides procedural nature props. The maintained Adventure skin is native- and WASM-framebuffer verified. | verified | A valid 15/15 native village retains all three Dens while rendering the Accounting Tent as a separate open ledger station; accepted staged-wall and exterior-farm framebuffers close the integrated world gate |
| CI/hosting | Forgejo quality workflow and combined non-root server/WASM image are committed. | deferred | Hosting live probes and deployment docs are verified. The first workflow execution requires an authorized push and is not a local gameplay/design gap. |

## Player playtest feedback — 2026-07-13

These are product requirements discovered by playing the native client. Their status and evidence
are maintained below; the current compact-HUD visual gate is tracked in `docs/FIX_LOG.md`.
...
| Global and personal villages | The secure foundation is live: one larger ownerless 30-cat/six-Den communal hub; one exact 15-cat/three-Den owner-only personal village per stable identity at a deterministic distant site; restart-persistent selection; returned-scout contact; shared physical terrain/ecology; and signed barter whose scalar and exact-equipment cargo travels as a persisted visible obstacle-aware land caravan. | verified | Scale/ownership/privacy/discovery/shared overlap, deterministic gate routing, no-route atomicity, restart, and physical caravan conservation are verified |
...
| Research tree scale and UX | The truthful about-500 catalog provides exactly 487 nodes: 165 building, 167 recipe/resource, and 155 upgrade studies with stable IDs, typed payloads, AND prerequisites, and layout coordinates. All 487 are purchasable and persistent; no card remains disabled as `FUTURE`. Thirteen former containerless capacity nodes are absent with migration refunds. The living Leader chooses at most one affordable study per rolling real-life day. All 108 maintained runtime recipes are authoritative. | verified | Quantitative category, 487/487 dependency-order purchase, zero-FUTURE, exact thirteen service mapping, migration, signed server/SQLite, deterministic Leader selection, descriptor, research UI, and strict gates |
...
| Roads | Authored stone roads and traffic-formed dirt roads are disjoint snapshot surfaces with cool-stone/warm-earth rendering. Stone roads move at 175%, dirt paths at 105%; mountain, cave, water, and authored stone ground cannot auto-form dirt. The founding cross connects the shrine to its single south gate and exterior approach, and lone/straight/corner/T/cross art resolves from the complete 16-mask neighbor grammar. | verified | Wear-threshold and forbidden-surface boundaries, protocol compatibility, connectivity/mask tests, and generalized inspection of founding and player-authored junctions pass. |
...
| --- | --- | --- |
| `docs/GAME_VISION.md` | reconciled current intent | Seven-role ownership, exact controls, physical work, all ten processor types and 108 recipes, all 487 live research studies, the larger communal blueprint, personal villages, physical trade, and the integrated correction gate are verified |
| `docs/ARCHITECTURE.md` | reconciled | Keep phase/action/test inventories and physical ten-processor/Steward/Accountant behavior synchronized with code |
| `docs/HANDOFF.md` | reconciled | Keep NEXT STEPS and verified evidence synchronized here |
| `docs/migration/BOARD.md` | migration history and reconciled expansion rollup | Preserve dated intermediate evidence while keeping the phase summary current |
| `p12-idle-cat-forest.md` | verified | Seven specialist roles plus the bounded Leader safety floor, role-building gates, signed manual work, selectable offerings, useful tools/costs, physical and wire-confidential Accountant reporting, all ten processor types, 108 recipes, Steward reserves, all 19 skills, and Forester replanting/regrowth pass focused and generalized gates |
| `p14-spatial-placement.md` | verified | Atomic placement/reservations/scaffold recovery, finite delivered scaffold inputs, resolved multi-cell decoration occupancy, soft obstacles, exact roads, exterior agricultural claims, staged atomic wall/gate cutover, and generalized native frames pass |
| `p15-playtest-feedback.md` | verified | Roads, exact placement, governance, labor pressure, knowledge-blind shrine-return scouting, secure villages, shared physical trade, and complete recipe/resource breadth pass the integrated correction campaign |
| `p16-village-blueprint.md` | verified | The founding lifecycle/store mix, 16px logical grid, clearing, exterior water, roads/gate, gather controls, fishing, agricultural territory, founding benches, and all physical queue/work/delivery routes are verified |
| `p17-biome-generator.md` | verified | Twenty-six fine biomes own movement, fertility, extraction/resource hints, fishing, and constructed rail/shipping behavior |
| `p18-visual-polish.md` | verified | Open stations, Accounting Tent, label-free map, timber walls, exterior agriculture, Adventure skin, unique semantic glyphs, compact world HUD, complete Stores menu, categorized command dock, and 487/487 zero-`FUTURE` research state pass generalized narrow/wide native inspection |
| `p19-items-materials-trade.md` | verified canonical taxonomy | Stable source/station names, all ten processor types, all 108 physical recipes, Fibre→Thread→Cloth, canonical Mug materials, all material families, exact finite goods, functional equipment, scaffold delivery, wear/repair, physical visiting/village trade, and generalized campaign evidence pass |
...
| --- | --- |
| Needs, autonomous survival, aging, genetics, breeding, skills, specialization, leaders, elections, raids, death, and extinction recovery | Carried at the world-tick level into deterministic `cat-sim`; Eat/Drink/Sleep now use finite stock pickup, physical destinations, five-bed Den reservations, and durable return-to-work routes rather than abstract restoration. The current design deliberately replaces the prototype's 48/57.6-hour old-age thresholds with 240/288 hours and replaces its five-cat recovery roster with the 15-adult/three-Den invariant. |
...
| Click-to-feed/heal/assign/fight and a browser task queue | Superseded by signed typed management actions and the verified seven-role manual-to-officer loop; coordinate placement, governance, variant/removal, durable per-cat labor preferences, and editable queue controls for all ten physical processors are live |
| Blessings, buildings, and the original ~18-node research tree | Carried forward and expanded: active shrine faucets, useful tools, escalating costs, all 487 research studies, deterministic Leader-owned daily selection, persistence, and modeled effects are verified. All 108 recipes and every generated resource stage have authoritative consumers. Twelve Crews nodes expand real concurrent stations; the other thirteen stable Crews IDs are completed-building services, including physical Mouse Farm Food, rather than fake worker slots. Durability affects repair/output, physical recipe studies gate maintained operations, and building placement is authoritative. Research labor/building automation and rituals remain Loremaster-owned. |
| Multiple colonies and inter-colony trade | Carried forward and extended: a larger durable communal hub, exact personal foundings, secure ownership, shrine-knowledge contact, one world-scoped mutable terrain/Fish authority, and physical scalar/exact-equipment caravans are live alongside visiting traders. Village caravans use deterministic shared-terrain land routing through both current gates; water, mountains, and closed wall edges block them without leaking fog. |
...
| Historical roadmap stretch items such as traveler interception and elevation-aware zones | Not current commitments. Finite-source physical fishing and physical rail/ship transport were later promoted and are verified above. |
...
silently omitted ten post-P19 variants. It now performs and asserts all 52 `ClientAction` variants
...
The focused guided group passes all 14 cases. The complete simulation gate passes all 1,351 tests
(two intentional release-evidence skips), including the long economy, research, fishing, textile, migration,
...
Dens and 15/15 housing, granted the normal Accounting prerequisites, and added a separate valid
...
the then-500/500 dependency-order purchase graph, per-payload resolution, signed server actions, SQLite round
...
failure, and the then-500-node research ledger clipped cards/connectors correctly while edge-panned.
...
The Wood Cutter full-world gate exposed a disconnected exterior-to-exterior farmer assignment.
Farm routes now retry a failed direct path as two real A* legs through the retained gate. An
unladen unreachable worker is released without disabling Farmer automation and a reachable
replacement is selected; a laden worker remains suspended in place with the exact basket
conserved. The five 300-game-hour population campaigns retain zero physical farm route misses.
