...
| `p15-playtest-feedback.md` | partial | Roads, exact footprints/depth, coordinate placement, governance controls, knowledge-blind shrine-return scout travel, and secure village foundations are fixed; finish the baseline Leader close-out, physical shared-world depth, and broader station-local production |
