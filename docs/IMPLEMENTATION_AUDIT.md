...
| `p19-items-materials-trade.md` | canonical taxonomy, implementation partial | Stable source/station names, open-top stations, all ten processors, all 104 physical recipes, complete food/plant, subsistence/frontier, and industrial material families, exact finite goods, functional equipment, scaffold delivery, wear/repair, and physical trade are live. Deeper per-tile/per-building inventories remain future design depth. |
