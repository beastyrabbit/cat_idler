...
| --- | --- | --- |
| `docs/GAME_VISION.md` | current intent, partially implemented | Seven-role ownership, exact controls, physical farm labor, all ten maintained processor routes, the complete 500-node research catalog/purchase/persistence/client ledger, and the distinct larger communal blueprint are verified; finish unconsumed research payloads, sourced recipe/resource breadth, broader local inventories, and authoritative shared-space/physical-trade depth |
