...
| Shared-world depth | A durable `Communal` scale gives the ownerless global hub 30 adults, six five-bed Dens, a 19×19 clear core, doubled raw workshops/runway, finite storage, and FoodStorage/ResearchHut/Barracks civic buildings; `Personal` villages remain exact 15/3/13×13 settlements, including extinction recovery. Mutable tiles, roads/wear, depletion/regrowth, and Fish populations now have one world-scoped authority with deterministic overlap ordering and legacy migration; fog/contact remain private. Contact is still a delivered summary and barter swaps scalar resources without physical cats, items, or routes. | in progress | Overlap road/depletion/Fish consistency, once-per-coordinate ecology, signed guidance, fog-safe snapshot projection, SQLite migration/restart, communal/personal blueprints, ownership and discovery are verified; implement physical encounter and item/caravan trade |
...
| Global and personal villages | The secure foundation is live: one larger ownerless 30-cat/six-Den communal hub; one exact 15-cat/three-Den owner-only personal village per stable identity at a deterministic distant site; restart-persistent selection; returned-scout contact; and signed bounded barter. Durable scale keeps founding and extinction profiles distinct. Physical terrain/ecology is shared without merging fog or contact; meeting/trade are not yet physical. | in progress | Scale/ownership/privacy/discovery/barter, world-scoped terrain/Fish persistence, overlap consistency, signed two-player control, deterministic communal viability, and selector/census are verified; add physical meeting and item/caravan trade |
...
| Multiple colonies and inter-colony trade | Carried forward and extended: a larger durable communal hub, exact personal foundings, secure ownership, shrine-knowledge contact, direct consensual resource barter, and one world-scoped mutable terrain/Fish authority are live alongside visiting traders. Physical meeting/item/caravan trade remains open. |
