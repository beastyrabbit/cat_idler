...
| Production breadth | The maintained production chains include physical Fibre→Cloth, Hide→Leather, and selected Metal→Weapon/Armor. Broader sourced recipes and variants remain. | in progress | Build/staff/produce sourced recipe breadth from player actions |
| Fine-biome resource ecology | All 26 fine biomes affect travel. Mountains now own finite Gem deposits, marsh/swamp/badlands own finite Clay, and beach/desert own finite Sand; physical quarry pickup drains the exact persisted tile and distinct cargo must reach storage before aggregate credit. Village interiors remain resource-free. Bone/Gem/Clay/Sand downstream item and recipe variants are still incomplete. | in progress | Exhaustive 26-biome deposit presence/absence, finite trip/depletion/conservation, no coarse-role deposit invention, founding clearing, persistence, protocol, HUD/cargo identity, and deterministic survival/tool regressions verify the source boundary; complete downstream recipes and player targeting |
| Research effect truth | The 487-node dependency graph, supported purchases, persistence, daily Leader choice, and 169 global scalar modifiers are live. Physical yield and durability modifiers have real consumers. Twelve capacity targets cover general Food/Water/Smithy storage plus nine processor-local input/output/transit stores; thirteen containerless studies are omitted with one-time refunds. Thirteen runtime recipes are physical: ten research-gated and three founding baselines, including split Mill operations and Smithy Tool/Weapon/Armor. Twelve Crews studies add independently owned worker/provenance/queue/pause/progress/skill/tool stations while sharing finite building stores in stable order. Thirteen unsafe/passive Crews families and 91 recipe plus 64 resource promises remain visible, non-purchasable `FUTURE` content and do not block later studies. | in progress | Physical yield/durability, twelve capacity domains, exact trade isolation, v7 migration, signed farm→Mill and Ore→metal-Tool, passive metal-Tool, thirteen recipe descriptors, twelve concurrent labor domains, death/reassignment/restart, FUTURE UI/denial, and the recipe/resource matrix are verified. Add sourced breadth; activate another Crews node only with a real concurrent labor state machine. |
...
| Item and recipe breadth | The item taxonomy is broad, but live crafting covers a small wood/stone/cloth/leather subset. Raw Bone, Gem, Clay, and Sand are now sourced physically and persist/trade independently, while their item variants and most generated recipes/resources remain incomplete. Functional Tool/Weapon/Armor chains have one finite-object authority; stable scalar fields are derived compatibility projections. | open | Craft every maintained material/category combination while preserving the verified finite equipment authority across quality, inventory, use, repair, trader, protocol, persistence, and UI |
...
| Research tree scale and UX | The truthful about-500 catalog provides exactly 487 nodes: 165 building, 167 recipe/resource, and 155 upgrade studies with stable IDs, typed payloads, AND prerequisites, and layout coordinates. Both product categories exceed the one-third design floor. The eleven-node Construction branch is truthfully building-related because every purchase changes the live physical-scaffold timer; no fake capacity nodes were restored. Supported studies are purchasable and persistent; unsupported generated promises remain visible as disabled `FUTURE` cards. Thirteen former containerless capacity nodes are absent with migration refunds. The living Leader chooses at most one affordable supported study per rolling real-life day. Thirteen maintained runtime recipes are authoritative: ten research-gated and three founding baselines. | verified | Quantitative one-third guards in sim and client, exhaustive Construction category/live-payload checks, supported dependency-order purchase, atomic future denial, exact 91 recipe/64 resource future count, retired-node refund and v7 queue migrations, signed server/SQLite behavior, deterministic Leader selection, thirteen descriptors, research UI/framebuffer, and strict gates |
...
| `p19-items-materials-trade.md` | canonical taxonomy, implementation partial | Its production table now resolves P12/P16 terminology while preserving stable IDs and every existing open-top station. Raw Stone and Bone are distinct physical cargo; quarry rubble, mountain Ore, hunt Hide/Bone, foraged Fibre, finite fresh Fish, all ten physical processors, 13 selected recipes, exact finite functional equipment, scaffold delivery, weighted wear/break/material repair, and the physical finite shrine trader are live. Remaining work is the 91 recipe/64 resource future breadth in `RECIPE_RESOURCE_MATRIX.md`, Bone and broader material/item recipes, deeper inventories, and transport. |
